ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Solidare It G6"
  ...
  # config.current_user_method = :current_admin_user ## ActiveAdmin
  config.current_user_method = :current_user ## Device
  ...
  #
  # Default:
  # config.logout_link_path = :destroy_admin_user_session_path ## ActiveAdmin
  config.logout_link_path = :destroy_user_session_path ## Devise

  # This setting changes the http method used when rendering the
  # link. For example :get, :delete, :put, etc..
  #
  # Default:
  # config.logout_link_method = :get ## ActiveAdmin
  config.logout_link_method = :delete ## Devise
